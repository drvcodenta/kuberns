"""
Django settings for kuberns_backend project.
...
# Load .env file (so AWS keys etc. are available via os.environ)
load_dotenv()
...
SECRET_KEY = 'django-insecure-s+j9w0yzs-#5r-+(_1)k12-)4fb$1(556id77ho-23xdel7+*q'
...
ROOT_URLCONF = 'kuberns_backend.urls'
